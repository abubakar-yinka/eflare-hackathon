...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"client","htmlAttrs":{"lang":"en"},"target":"static","ssr":false,"generate":{"fallback":true},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_vuemap_2152f590 === 'function') {
    await nuxt_plugin_vuemap_2152f590(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_fusion_79e788bd === 'function') {
    await nuxt_plugin_fusion_79e788bd(app.context, inject)
  }
